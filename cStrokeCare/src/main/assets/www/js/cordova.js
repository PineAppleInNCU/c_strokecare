...
// file: lib/common/plugin/AngularSpeed.js
define("cordova/plugin/AngularSpeed", function(require, exports, module) {
...
// file: lib/common/plugin/gyroscope.js
define("cordova/plugin/gyroscope", function(require, exports, module) {

/**
 * This class provides access to device AngularSpeed data.
 * @constructor
 */
var argscheck = require('cordova/argscheck'),
    utils = require("cordova/utils"),
    exec = require("cordova/exec"),
    Acceleration = require('cordova/plugin/AngularSpeed');
...
function start() {
    exec(function(a) {
        var tempListeners = listeners.slice(0);
        speed = new Acceleration(a.x, a.y, a.z, a.timestamp);
        for (var i = 0, l = tempListeners.length; i < l; i++) {
...
var gyroscope = {
     ...
     * @param {Function} errorCallback      The function to call when there is an error getting the acceleration data. (OPTIONAL)
     * @param {AccelerationOptions} options The options for getting the gyroscope data such as timeout. (OPTIONAL)
     */
...
// file: lib/common/plugin/gyroscope/symbols.js
define("cordova/plugin/gyroscope/symbols", function(require, exports, module) {


var modulemapper = require('cordova/modulemapper');

modulemapper.defaults('cordova/plugin/AngularSpeed', 'AngularSpeed');
modulemapper.defaults('cordova/plugin/gyroscope', 'navigator.gyroscope');
