...
cordova.define("cordova/plugin/bluetooth", function(require, exports, module) {
	...
	Bluetooth.prototype.passValue = function (successCallback,failureCallback,name){
   							console.log("Prima di execute!");
   							return exec(successCallback,failureCallback,'BluetoothPlugin','passValue',[name]);
  	}


  	Bluetooth.prototype.stopPebble = function(successCallback,failureCallback) {
	    return exec(successCallback, failureCallback, 'BluetoothPlugin', 'stopPebble', []);
	}
	...
	Bluetooth.prototype.startPebble = function(successCallback,failureCallback) {
	    return exec(successCallback, failureCallback, 'BluetoothPlugin', 'startPebble', []);
	}
	/**
	 * Disable bluetooth
	 * 
